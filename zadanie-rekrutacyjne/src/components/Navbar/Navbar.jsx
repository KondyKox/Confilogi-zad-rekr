...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="navbar" onMouseEnter={() => setIsModalOpen(true)}>
        ...
        {isMenuOpen && isMobile < 1024 && (
          <div className="mobile__menu">
            ...
            <div className="mobile__link__container">
              <a href="#features" className="link mobile-link">
                features
              </a>
              <a href="#pricing" className="link mobile-link">
                pricing
              </a>
              <a href="#contact" className="link mobile-link">
                contact
              </a>
              <a href="#" className="special-mobile-link mobile-link">
                login
              </a>
            </div>
